...
const updateProgrammeSchema = z.object({
  ...
  contactOrganisme: z.string().min(1, 'Le contact organisme est requis').optional(),
  referentPedagogique: z.string().min(1, 'Le référent pédagogique est requis').optional(),
  referentQualite: z.string().min(1, 'Le référent qualité est requis').optional(),
  ...
  horaires: z.string().min(1, 'Les horaires sont requis').optional(),
  evaluationSur: z.string().optional(),
